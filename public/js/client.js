...
const welcomeImg = "../images/kool.gif";
const shareUrlImg = "../images/kool.gif";
const leaveRoomImg = "../images/leave-room.png";
const confirmImg = "../images/kool.gif";
const fileSharingImg = "../images/kool.gif";
...
const aboutImg = "../images/kool.gif";
...
let recStartTime;
let recElapsedTime;
let गुरुkoolTheme = "neon"; // neon - dark - forest - ghost ...
...
function getHtmlElementsById() {
  ...
  selectheme = getId("गुरुkoolTheme");
...
function welcomeUser() {
  ...
  Swal.fire({
    ...
    if (result.isConfirmed) {
      ...
      let message = {
        email: "",
        subject: "Please join our गुरुkool conference",
      ...
      switch (event.channel.label) {
        case "गुरुkool_chat_channel":
          try {
            ...
            console.error("गुरुkool_chat_channel", err);
          }
          break;
        case "गुरुkool_file_sharing_channel":
          try {
            let dataFile = msg.data;
            handleDataChannelFileSharing(dataFile);
          } catch (err) {
            console.error("गुरुkool_file_sharing_channel", err);
          }
          break;
      }
    };
...
/**
 * Set गुरुkool theme neon | dark | forest | sky | ghost | ...
 * @param {*} theme
 */
...
function setButtonsBarPosition(position) {
  ...
  switch (BtnsBar) {
    case "vertical":
      let btnsLeft = गुरुkoolTheme === "ghost" ? "5px" : "20px";
...
function showAbout() {
  ...
  Swal.fire({
    background: swalBackground,
    position: "center",
    title: "<strong>गुरुkool Made with ❤️</strong>",
    imageAlt: "About",
    imageUrl: aboutImg,
    showClass: {
      popup: "animate__animated animate__fadeInDown",
